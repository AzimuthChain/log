# log [![godoc reference](https://godoc.org/github.com/metrachain/log?status.png)](https://godoc.org/github.com/metrachain/log) [![Build Status](https://travis-ci.org/metrachain/log.svg?branch=master)](https://travis-ci.org/inconshreveable/log15)
...
```go
import log "github.com/metrachain/log"
```
